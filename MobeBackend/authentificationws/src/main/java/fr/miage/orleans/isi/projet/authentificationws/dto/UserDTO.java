...
public class UserDTO {
    ...
    public static UserDTO createUserDTO(User user) {
        ...
        userDTO.setRoles(getListRoleDTOFromListBasic(user.getRoles()));
        userDTO.setNom(user.getNom());
        userDTO.setPrenom(user.getPrenom());
        userDTO.setMail(user.getMail());
        userDTO.setDateInscription(user.getDateInscription());
        userDTO.setMoyenPaiements(getListMPDTOFromBasic(user.getMoyensPaiement()));
        userDTO.setTransactions(getListTransacDTOFromBasic(user.getTransactions()));
        return userDTO;
    }

    private static List<TransactionDTO> getListTransacDTOFromBasic(List<Transaction> transactions) {
    ...
    private static List<RoleDTO> getListRoleDTOFromListBasic(List<Role> roles) {
    ...
    private static List<MoyenPaiementDTO> getListMPDTOFromBasic(List<MoyenPaiement> mps){

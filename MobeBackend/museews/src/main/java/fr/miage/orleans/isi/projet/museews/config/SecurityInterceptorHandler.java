...
import fr.miage.orleans.isi.projet.museews.exceptions.JwtTokenMissinException;
...
public class SecurityInterceptorHandler implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Object o) throws Exception {
        ...
        try {
            ...
            if(login != null && login.equals(response.body())) {
                LOGGER.info("Jwt valid : Request Authorized");
                return true;
            }else {
    ...
    public void postHandle(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Object o, ModelAndView modelAndView) throws Exception {
        ...
        LOGGER.info("Response : " + HttpStatus.valueOf(responseCodeStatus));
    }
